...
import {IClients, IChannels, IClient, IUsers, IUser, EmittingData} from './interfaces';
...
const emitGameStatus = () => {
    if (channels && channels['1']) {
        ...
        const gameEvent = numberOfUsersCurrentlyInGame === 1 ? GAME_EVENTS.waitingForPlayers : GAME_EVENTS.gameStarted;
